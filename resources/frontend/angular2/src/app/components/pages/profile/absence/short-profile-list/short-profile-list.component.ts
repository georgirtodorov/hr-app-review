...
@Component({
    selector: 'short-profile-list',
    templateUrl: './short-profile-list.component.html',
    styleUrls: ['./short-profile-list.component.scss']
})
export class ShortProfileListComponent implements OnInit {
    ...
    public edit(request) {
        this.dialog.open(DialogAbsenceRequestComponent, {
            data: {
                request: request
            }
        })
